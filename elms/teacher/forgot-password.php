...
$con="update teacher set Password=:newpassword where id=:empid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>SHS | Password Recovery</title>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>Tech Password Recovery</a></li>
                
                       <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons">account_box</i>Admin Login</a></li>
                
                </ul>
          <div class="footer">
                    <p class="copyright"><a href="http://phpgurukul.com/">Rahul Raj </a>©</p>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM teacher WHERE EmailId=:email and EmpId=:empid";
