...
$sql ="SELECT EmailId,Password,Status,id FROM teacher WHERE EmailId=:uname and Password=:password";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Student Help | Home Page</title>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">Student Help System</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>S. Password Recovery</a></li>
                
                       <li class="no-padding"><a class="waves-effect waves-grey" href="../admin/"><i class="material-icons">account_box</i>Admin Login</a></li>

                       <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><i class="material-icons">account_box</i>Teacher Login</a></li>
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Student Help System</h4></div>
