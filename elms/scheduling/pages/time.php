...
<html>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    ?>
                ...
                <td><?php echo $end;?></td>
                <td><?php echo $day;?></td>               
                <td><a id="click" href="time.php?id=<?php echo $id;?>&room=<?php echo $room;?>">
		...
		<div class="col-md-6">
          ...
          <div class="row">
           <div class="col-md-12">
              ...
              <div class="form-group">
              <label for="date">Update Time</label><br>
                <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $_REQUEST['id'];?>" placeholder="Room ID" readonly>
                <input type="text" class="form-control" id="class" name="room" value="<?php echo $_REQUEST['time'];?>" placeholder="Room" required>
              </div><!-- /.form group -->
          </div>
          </div>  
