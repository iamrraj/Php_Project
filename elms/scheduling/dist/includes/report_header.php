...
<style>
	...
	<h3 onClick="window.print()" style="text-align: center; color: blue; border: 2px solid green; padding: 10px;  "> University Of Social Scince , Warsaw </h3>
<h4 align = "center">
<h4 align = "center">
...
<h4 align="center" style="margin-top: -15px;margin-bottom: 10px">
