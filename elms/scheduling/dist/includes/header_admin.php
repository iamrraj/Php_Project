            ...
            <!-- Navbar Right Menu -->
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                  ...
                  <li class="">
                    <!-- Menu Toggle Button -->
                   <a href="../../admin/dashboard.php" style="color:#fff;" class="dropdown-toggle">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        ...
                        <ul class="menu">
                          ...
                          <li><!-- start notification -->
                            <a href="time.php">
                              <i class="glyphicon glyphicon-scale text-green"></i> Time
                            </a>
                          </li><!-- end notification -->
                          ...
                          <li><!-- start notification -->
                            <a href="room.php">
                              <i class="glyphicon glyphicon-user text-green"></i> Room
                            </a>
                          </li><!-- end notification -->
