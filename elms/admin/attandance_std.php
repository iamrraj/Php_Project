...
$sql="INSERT INTO attandance(Name,Gender,Department,Status) 
VALUES(:fname,:gender,:department,:status)";
...
if($lastInsertId)
{
$msg="Attandance record added Successfully";
}
else 
{
...
<select  name="name" autocomplete="off" id="empcode" onBlur="checkAvailabilityEmpid()" >
<option value="">Student Name</option>
<?php $sql = "SELECT FirstName from tblemployees";
$query = $dbh -> prepare($sql);
$query->execute();
